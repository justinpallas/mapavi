...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.tabview.grid(row=0, column=1, padx=(
        ...
        self.freqband_label_list = [self.freqband_label_1, self.freqband_label_2, self.freqband_label_3,
                                    self.freqband_label_4, self.freqband_label_5, self.freqband_label_6, self.freqband_label_7]
        self.f1_entry_list = [self.entry_f1_1, self.entry_f1_2, self.entry_f1_3,
                              self.entry_f1_4, self.entry_f1_5, self.entry_f1_6, self.entry_f1_7]
        self.f2_entry_list = [self.entry_f2_1, self.entry_f2_2, self.entry_f2_3,
                              self.entry_f2_4, self.entry_f2_5, self.entry_f2_6, self.entry_f2_7]
        self.tab_1_level_entry_list = [self.tab_1_entry_level_1, self.tab_1_entry_level_2, self.tab_1_entry_level_3,
                                       self.tab_1_entry_level_4, self.tab_1_entry_level_5, self.tab_1_entry_level_6, self.tab_1_entry_level_7]
        ...
        self.thirdband_label_list = [self.thirdband_label_1, self.thirdband_label_2, self.thirdband_label_3,
                                     self.thirdband_label_4, self.thirdband_label_5, self.thirdband_label_6, self.thirdband_label_7]
        self.fc_entry_list = [self.entry_fc_1, self.entry_fc_2, self.entry_fc_3,
                              self.entry_fc_4, self.entry_fc_5, self.entry_fc_6, self.entry_fc_7]
